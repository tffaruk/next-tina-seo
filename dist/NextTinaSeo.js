...
var NextTinaSeo = function NextTinaSeo(_ref) {
  ...
  return __jsx(_head["default"], null, __jsx("title", null, (0, _textConverter.plainify)(meta_title ? meta_title : title ? title : _config["default"].site.title)), canonical && __jsx("link", {
    rel: "canonical",
    href: canonical,
    itemProp: "url"
  }), noindex && __jsx("meta", {
